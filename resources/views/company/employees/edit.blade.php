...
<div class="container-fluid py-4">
    <div class="page-header d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="page-subtitle">Atualize os dados do funcionário</p>
        </div>
    ...
    <div class="card shadow">
        <div class="card-body">
            <form action="{{ route('company.employees.update', $employee) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select @error('type') is-invalid @enderror" id="type" name="type" required>
                            ...
                            <option value="clt" {{ old('type', $employee->type) === 'clt' ? 'selected' : '' }}>CLT</option>
                            <option value="pj" {{ old('type', $employee->type) === 'pj' ? 'selected' : '' }}>PJ</option>
                            <option value="freelancer" {{ old('type', $employee->type) === 'freelancer' ? 'selected' : '' }}>Freelancer</option>
                        </select>
                        @error('type')
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control @error('role') is-invalid @enderror" id="role" name="role" value="{{ old('role', $employee->role) }}">
                        @error('role')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select @error('status') is-invalid @enderror" id="status" name="status">
                            ...
                            <option value="dismissed" {{ old('status', $employee->status) === 'dismissed' ? 'selected' : '' }}>Demitido</option>
                        </select>
                        @error('status')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            <input type="number" step="0.25" min="0" max="24" class="form-control @error('daily_hours_goal') is-invalid @enderror" id="daily_hours_goal" name="daily_hours_goal" value="{{ old('daily_hours_goal', $employee->daily_hours_goal ?? 8) }}">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            <input type="number" step="0.25" min="0" max="1000" class="form-control @error('monthly_hours_goal') is-invalid @enderror" id="monthly_hours_goal" name="monthly_hours_goal" value="{{ old('monthly_hours_goal', $employee->monthly_hours_goal) }}" placeholder="Automático">
                            <span class="input-group-text">h</span>
                        </div>
