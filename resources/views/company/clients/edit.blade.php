...
<div class="container-fluid py-4">
    ...
    <div class="card shadow">
        <div class="card-body">
            <form action="{{ route('company.clients.update', $client) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select @error('type') is-invalid @enderror" id="type" name="type" required>
                            ...
                            <option value="pf" {{ old('type', $client->type) === 'pf' ? 'selected' : '' }}>Pessoa Física</option>
                            <option value="pj" {{ old('type', $client->type) === 'pj' ? 'selected' : '' }}>Pessoa Jurídica</option>
                        </select>
                        @error('type')
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('document') is-invalid @enderror" id="document" name="document" value="{{ old('document', $client->document) }}">
                        @error('document')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control @error('state') is-invalid @enderror" id="state" name="state" value="{{ old('state', $client->state) }}" maxlength="2">
                        @error('state')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
