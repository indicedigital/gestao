...
<div class="page-header">
    ...
    <p class="page-subtitle">Atualize as informações da empresa</p>
</div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select 
                        ...
                        name="status"
                    >
                        <option value="active" {{ old('status', $company->status ?? 'active') === 'active' ? 'selected' : '' }}>Ativa</option>
                        <option value="suspended" {{ old('status', $company->status) === 'suspended' ? 'selected' : '' }}>Suspensa</option>
                        <option value="cancelled" {{ old('status', $company->status) === 'cancelled' ? 'selected' : '' }}>Cancelada</option>
                    </select>
                    @error('status')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
